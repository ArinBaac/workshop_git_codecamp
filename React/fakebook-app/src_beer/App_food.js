...
// เพิ่ม field ของ food ให้มีแหล่งที่มา 
// text box ก็เพิ่มเข้ามาด้วย 
// (Optional) ทำให้ แหล่งที่มาเป็น dropdown list
class FoodInput extends React.Component {
  ...
  addFood = () => {
    this.props.addFoodItem(this.state.foodNameTb, this.state.foodCostTb);
  }
  updateFood = () => {
